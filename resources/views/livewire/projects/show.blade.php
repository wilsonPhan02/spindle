        ...
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-12 mb-16 items-stretch">
            ...
            >
                @if($project->cover_image_path)
                    ...
                    <div class="absolute top-3 bottom-3 right-2 w-4 bg-gradient-to-r from-[#E8E3D9] to-[#D5C6A9] border-y border-r border-[#C4B7A3] rounded-r-sm z-10 shadow-inner"></div>
                ...
                @else
                    <x-default-project class="absolute inset-y-0 left-0 right-4 w-[calc(100%-16px)] h-full text-[#B69F78] rounded-l-md rounded-r-lg shadow-md z-20 border-r border-black/10" />
                    <div class="absolute top-3 bottom-3 right-2 w-4 bg-gradient-to-r from-[#E8E3D9] to-[#D5C6A9] border-y border-r border-[#C4B7A3] rounded-r-sm z-10 shadow-inner"></div>
                    <div class="absolute inset-y-0 right-0 w-4 bg-[#8C7558] rounded-r-lg z-0 shadow-xl border-l border-black/20"></div>
                @endif
