    ...
    <div class="p-6 lg:p-10 max-w-7xl mx-auto">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                @foreach([
                    ['title' => 'Structure', 'icon' => 'no-structure', 'desc' => 'You Didn\'t Have Any Chapters!', 'btn' => 'View Structure', 'href' => null],
                    ['title' => 'Character', 'icon' => 'no-character', 'desc' => 'You Didn\'t Have Any Characters!', 'btn' => 'View Character', 'href' => route('projects.characters', $project)],
                    ['title' => 'Notes', 'icon' => 'no-notes', 'desc' => 'You Didn\'t Have Any Notes!', 'btn' => 'View Notes', 'href' => null]
                ] as $workspace)
                ...
                <div class="bg-[#EAE1D5] rounded-xl p-8 flex flex-col justify-between h-[360px] shadow-sm border border-brand-100 hover:shadow-md transition-shadow">
                    ...
                    @if($workspace['href'])
                        <a href="{{ $workspace['href'] }}" wire:navigate class="w-full py-3 mt-4 border border-[#D5C6A9] bg-transparent rounded-lg text-[14px] font-bold text-[#4A4A4A] hover:bg-[#DFD5C5] transition-colors text-center">
                            {{ $workspace['btn'] }}
                        </a>
                    @else
