...
<div class="flex flex-col items-center justify-center min-h-screen bg-[#F2EFEC]">
    ...
    <div class="w-full max-w-md p-6 bg-[#FFFEFB] border border-transparent rounded-xl shadow-md">
        ...
        <h1 class="mb-5 text-2xl font-serif text-center text-[#37322E]">Sign In</h1>

        <form wire:submit="login" class="space-y-3">
            
            <div>
                <label class="block mb-1 text-sm font-medium text-[#37322E]">Email/ Username</label>
            ...
            <div class="flex items-center justify-between pt-1">
                <div class="flex items-center">
                    ...
                    <label for="remember" class="ml-2 text-sm text-[#37322E]">Remember me</label>
                </div>
